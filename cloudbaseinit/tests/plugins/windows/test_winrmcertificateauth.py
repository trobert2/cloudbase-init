...
class ConfigWinRMCertificateAuthPluginTests(unittest.TestCase):
    ...
    @mock.patch('cloudbaseinit.utils.windows.security.WindowsSecurityUtils'
                '.set_local_account_token_filter_policy')
    @mock.patch('cloudbaseinit.utils.windows.security.WindowsSecurityUtils'
                '.get_local_account_token_filter_policy')
    def _test_execute(self, mock_get_token, mock_set_token, mock_get_os_utils,
